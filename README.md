...
1) All testing blocks include inference.  For inference testing performance may vary frow non-real-time to accelerated many times faster than real-time, depending on available cloud resources.  An inference block is shown explicitly when real-time performance is required.
